package com.vs.authserverboot3.config;
...
public class AuthorizationServerConfig {
    ...
    public RegisteredClientRepository registeredClientRepository() {
        var registeredClient = RegisteredClient.withId(UUID.randomUUID().toString())
                .clientId("client")
                .clientSecret("secret")
                .scopes(strings -> strings.addAll(List.of("read",OidcScopes.OPENID,OidcScopes.PROFILE)))
                ...
                .build();
        log.info("RegisterClient Details {} ",registeredClient);
